...
namespace pb {
	...
	PROTOBUF_CONSTEXPR SynPlayers::SynPlayers(
		::_pbi::ConstantInitialized) : _impl_{
			/*decltype(_impl_.ps_)*/{}
		  , /*decltype(_impl_._cached_size_)*/{} } {}
	struct SynPlayersDefaultTypeInternal {
		PROTOBUF_CONSTEXPR SynPlayersDefaultTypeInternal()
			: _instance(::_pbi::ConstantInitialized{}) {}
		~SynPlayersDefaultTypeInternal() {}
		union {
			SynPlayers _instance;
		};
	};
	PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SynPlayersDefaultTypeInternal _SynPlayers_default_instance_;
...
const uint32_t TableStruct_msg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::pb::SynPlayers, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::pb::SynPlayers, _impl_.ps_),
  ~0u,  // no _has_bits_
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::pb::_SynPlayers_default_instance_._instance,
...
#undef CHK_
	...
	class SynPlayers::_Internal {
	public:
	};

	SynPlayers::SynPlayers(::PROTOBUF_NAMESPACE_ID::Arena* arena,
		bool is_message_owned)
		: ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
		SharedCtor(arena, is_message_owned);
		// @@protoc_insertion_point(arena_constructor:pb.SynPlayers)
	}
	SynPlayers::SynPlayers(const SynPlayers& from)
		: ::PROTOBUF_NAMESPACE_ID::Message() {
		SynPlayers* const _this = this; (void)_this;
		new (&_impl_) Impl_{
			decltype(_impl_.ps_){from._impl_.ps_}
		  , /*decltype(_impl_._cached_size_)*/{} };

		_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
		// @@protoc_insertion_point(copy_constructor:pb.SynPlayers)
	}

	inline void SynPlayers::SharedCtor(
		::_pb::Arena* arena, bool is_message_owned) {
		(void)arena;
		(void)is_message_owned;
		new (&_impl_) Impl_{
	...
	SynPlayers::~SynPlayers() {
		// @@protoc_insertion_point(destructor:pb.SynPlayers)
		if (auto* arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
			(void)arena;
			return;
		}
	...
	inline void SynPlayers::SharedDtor() {
		GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
		_impl_.ps_.~RepeatedPtrField();
	}

	void SynPlayers::SetCachedSize(int size) const {
		_impl_._cached_size_.Set(size);
	}

	void SynPlayers::Clear() {
		// @@protoc_insertion_point(message_clear_start:pb.SynPlayers)
		uint32_t cached_has_bits = 0;
		// Prevent compiler warnings about cached_has_bits being unused
		(void)cached_has_bits;
	...
	const char* SynPlayers::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
		while (!ctx->Done(&ptr)) {
			uint32_t tag;
			ptr = ::_pbi::ReadTag(ptr, &tag);
...
#undef CHK_
	...
	uint8_t* SynPlayers::_InternalSerialize(
		uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
		// @@protoc_insertion_point(serialize_to_array_start:pb.SynPlayers)
		uint32_t cached_has_bits = 0;
		(void)cached_has_bits;
		...
		// @@protoc_insertion_point(serialize_to_array_end:pb.SynPlayers)
		return target;
	}

	size_t SynPlayers::ByteSizeLong() const {
		// @@protoc_insertion_point(message_byte_size_start:pb.SynPlayers)
		size_t total_size = 0;
	...
	const ::PROTOBUF_NAMESPACE_ID::Message::ClassData SynPlayers::_class_data_ = {
		::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
		SynPlayers::MergeImpl
	};
	const ::PROTOBUF_NAMESPACE_ID::Message::ClassData* SynPlayers::GetClassData() const { return &_class_data_; }


	void SynPlayers::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
		auto* const _this = static_cast<SynPlayers*>(&to_msg);
		auto& from = static_cast<const SynPlayers&>(from_msg);
		// @@protoc_insertion_point(class_specific_merge_from_start:pb.SynPlayers)
		GOOGLE_DCHECK_NE(&from, _this);
		uint32_t cached_has_bits = 0;
		(void)cached_has_bits;
	...
	void SynPlayers::CopyFrom(const SynPlayers& from) {
		// @@protoc_insertion_point(class_specific_copy_from_start:pb.SynPlayers)
		if (&from == this) return;
		Clear();
		MergeFrom(from);
	}

	bool SynPlayers::IsInitialized() const {
		return true;
	}

	void SynPlayers::InternalSwap(SynPlayers* other) {
		using std::swap;
		_internal_metadata_.InternalSwap(&other->_internal_metadata_);
		_impl_.ps_.InternalSwap(&other->_impl_.ps_);
	}

	::PROTOBUF_NAMESPACE_ID::Metadata SynPlayers::GetMetadata() const {
		return ::_pbi::AssignDescriptors(
			&descriptor_table_msg_2eproto_getter, &descriptor_table_msg_2eproto_once,
...
template<> PROTOBUF_NOINLINE::pb::SynPlayers*
Arena::CreateMaybeMessage< ::pb::SynPlayers >(Arena* arena) {
	return Arena::CreateMessageInternal< ::pb::SynPlayers >(arena);
}
