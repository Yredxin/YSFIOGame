...
namespace pb {
	...
	extern SynPlayersDefaultTypeInternal _SynPlayers_default_instance_;
	class SyncPid;
...
template<> ::pb::SynPlayers* Arena::CreateMaybeMessage<::pb::SynPlayers>(Arena*);
...
namespace pb {
	...
	class SynPlayers final :
		public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:pb.SynPlayers) */ {
	public:
		inline SynPlayers() : SynPlayers(nullptr) {}
		~SynPlayers() override;
		explicit PROTOBUF_CONSTEXPR SynPlayers(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

		SynPlayers(const SynPlayers& from);
		SynPlayers(SynPlayers&& from) noexcept
			: SynPlayers() {
			*this = ::std::move(from);
		}

		inline SynPlayers& operator=(const SynPlayers& from) {
			CopyFrom(from);
			return *this;
		}
		inline SynPlayers& operator=(SynPlayers&& from) noexcept {
			if (this == &from) return *this;
			if (GetOwningArena() == from.GetOwningArena()
#ifdef PROTOBUF_FORCE_COPY_IN_MOVE
				&& GetOwningArena() != nullptr
		...
		static const SynPlayers& default_instance() {
			return *internal_default_instance();
		}
		static inline const SynPlayers* internal_default_instance() {
			return reinterpret_cast<const SynPlayers*>(
				&_SynPlayers_default_instance_);
		}
		static constexpr int kIndexInFileMessages =
			2;

		friend void swap(SynPlayers& a, SynPlayers& b) {
			a.Swap(&b);
		}
		inline void Swap(SynPlayers* other) {
			if (other == this) return;
#ifdef PROTOBUF_FORCE_COPY_IN_SWAP
			if (GetOwningArena() != nullptr &&
				GetOwningArena() == other->GetOwningArena()) {
		...
		void UnsafeArenaSwap(SynPlayers * other) {
			if (other == this) return;
			GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
			InternalSwap(other);
		}
		...
		SynPlayers* New(::PROTOBUF_NAMESPACE_ID::Arena * arena = nullptr) const final {
			return CreateMaybeMessage<SynPlayers>(arena);
		}
		using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
		void CopyFrom(const SynPlayers & from);
		using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
		void MergeFrom(const SynPlayers & from) {
			SynPlayers::MergeImpl(*this, from);
		}
	private:
		static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message & to_msg, const ::PROTOBUF_NAMESPACE_ID::Message & from_msg);
	public:
	...
	private:
		...
		void SharedDtor();
		void SetCachedSize(int size) const final;
		void InternalSwap(SynPlayers * other);

	private:
		friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
		static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
			return "pb.SynPlayers";
		}
	protected:
		explicit SynPlayers(::PROTOBUF_NAMESPACE_ID::Arena * arena,
			bool is_message_owned = false);
	public:
	...
	public:
		...
		// @@protoc_insertion_point(class_scope:pb.SynPlayers)
	private:
		class _Internal;
...
// int32 pid = 1;
	...
	// repeated .pb.Player ps = 1;
	inline int SynPlayers::_internal_ps_size() const {
		return _impl_.ps_.size();
	}
	inline int SynPlayers::ps_size() const {
		return _internal_ps_size();
	}
	inline void SynPlayers::clear_ps() {
		_impl_.ps_.Clear();
	}
	inline ::pb::Player* SynPlayers::mutable_ps(int index) {
		// @@protoc_insertion_point(field_mutable:pb.SynPlayers.ps)
		return _impl_.ps_.Mutable(index);
	}
	inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::pb::Player >*
		SynPlayers::mutable_ps() {
		// @@protoc_insertion_point(field_mutable_list:pb.SynPlayers.ps)
		return &_impl_.ps_;
	}
	inline const ::pb::Player& SynPlayers::_internal_ps(int index) const {
		return _impl_.ps_.Get(index);
	}
	inline const ::pb::Player& SynPlayers::ps(int index) const {
		// @@protoc_insertion_point(field_get:pb.SynPlayers.ps)
		return _internal_ps(index);
	}
	inline ::pb::Player* SynPlayers::_internal_add_ps() {
		return _impl_.ps_.Add();
	}
	inline ::pb::Player* SynPlayers::add_ps() {
		::pb::Player* _add = _internal_add_ps();
		// @@protoc_insertion_point(field_add:pb.SynPlayers.ps)
		return _add;
	}
	inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::pb::Player >&
		SynPlayers::ps() const {
		// @@protoc_insertion_point(field_list:pb.SynPlayers.ps)
		return _impl_.ps_;
	}
